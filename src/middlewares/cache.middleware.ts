...
export const MChache = (options: ICacheOptions = {}) => {
    const {
        ttl = 300, // default 5s
        keyPrefix = "api_cache",
        skipCacheIf,
    ...
    return async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            if (cachedData) {
                ...
                return res.status(parsed.statusCode).json(JSON.parse(parsed.data));
            }
    ...
    return async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            res.json = function (data: any) {
                ...
                return orisinalJson.call(this, data);
            };
